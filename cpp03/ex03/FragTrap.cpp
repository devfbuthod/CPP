...
{
    std::cout << "FragTrap " << this->getName() << " mitraille " << target << ", il lui inflige " << this->getRangedDamAtt() << " points de dégats !" << std::endl;
}

void FragTrap::meleeAttack(std::string const & target)
{
    std::cout << "FragTrap " << this->getName() << " donne un coup de cross " << target << ", cela lui inflige " << this->getMeleeDamAtt() << " points de dégats !" << std::endl;
}
