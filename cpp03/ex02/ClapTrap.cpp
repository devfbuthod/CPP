...
{
    std::cout << "Le ClapTrap " << this->getName() << " jete une pierre à " << target << ", il lui inflige " << this->getRangedDamAtt() << " points de dégats !" << std::endl;
}

void ClapTrap::meleeAttack(std::string const & target)
{
    std::cout << "Le ClapTrap " << this->getName() << " donne un coup à " << target << ", cela lui inflige " << this->getMeleeDamAtt() << " points de dégats !" << std::endl;
}
...
void ClapTrap::takeDamage(unsigned int amount)
{
    ...
    {
        std::cout << this->getName() << " se fait écraser par un Garogo et perd " << dmg_taken << " point(s) de vie" << std::endl;
