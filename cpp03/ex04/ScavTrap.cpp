...
{
    std::cout << "ScavTrap " << this->getName() << " balance une bouteille d'eau dans la tete de " << target << ", il lui inflige " << this->getRangedDamAtt() << " points de dégats !" << std::endl;
}

void ScavTrap::meleeAttack(std::string const & target)
{
    std::cout << "ScavTrap " << this->getName() << " donne un coup de baton " << target << ", cela lui inflige " << this->getMeleeDamAtt() << " points de dégats !" << std::endl;
}
